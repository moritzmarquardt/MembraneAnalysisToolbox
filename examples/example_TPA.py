import MembraneAnalysisToolbox.DiffusionAnalysis as TPA
...
# Hex analysis
print("\nHEX analysis")
ffs, ffe, indizes = Analysis2nm_1.calc_passagetimes(
    ["resname HEX and name C1"], z_lower, L
)
...
print("\nDOD analysis")
ffs, ffe, indizes = Analysis2nm_1.calc_passagetimes(
    ["resname DOD and name C2"], z_lower, L
)
print("\tpassages: " + str(len(ffs)))
D = Analysis2nm_1.calc_diffusion(list(ffe - ffs), L)
print("\tDiffusioncoefficient: " + str(D).replace(".", ","))
